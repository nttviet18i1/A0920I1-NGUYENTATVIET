...
public class HousService {
    ...
    public static  void addNewHouse(){
      ...
      House newHouse= new House(id,name,areaUsed,rentCost,maxPeople,typeRent,standardRoom,detailConvenient,floor);
    ...
    public  static  void showHouse() {
       ...
       housesList = new ArrayList<>();
        ...
        for (String str: stringList) {
            temp = str.split(",");
            House house = new House(Integer.parseInt(temp[0]),temp[1],Double.parseDouble(temp[2]),Integer.parseInt(temp[3]),Integer.parseInt(temp[4]),temp[5],temp[6],temp[7],Integer.parseInt(temp[9]));
